...
function portfolio_register() {  
	...
	array(  
	    'hierarchical' => true,  
	    'labels' => array(
	    	'name' => __( 'Portfolio Categories', 'kratos' ),
	    	'singular_name' => __( 'Portfolio Category', 'kratos' ),
	    	'search_items' => __( 'Search Portfolio Categories', 'kratos' ),
	    	'popular_items' => __( 'Popular Portfolio Categories', 'kratos' ),
	    	'all_items' => __( 'All Portfolio Categories', 'kratos' ),
	    	'edit_item' => __( 'Edit Portfolio Category', 'kratos' ),
	    	'update_item' => __( 'Update Portfolio Category', 'kratos' ),
	    	'add_new_item' => __( 'Add New Portfolio Category', 'kratos' ),
	    	'new_item_name' => __( 'New Portfolio Category Name', 'kratos' ),
	    	'separate_items_with_commas' => __( 'Separate Portfolio Categories With Commas', 'kratos' ),
	    	'add_or_remove_items' => __( 'Add or Remove Portfolio Categories', 'kratos' ),
	    	'choose_from_most_used' => __( 'Choose From Most Used Portfolio Categories', 'kratos' ),  
	    	'parent' => __( 'Parent Portfolio Category', 'kratos' )      	
	    	),
	    'query_var' => true,  
	    'rewrite' => true  
		)  
